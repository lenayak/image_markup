...
class Ui_image_markup(object):
    def setupUi(self, image_markup):
        ...
        self.get_img_btn.setGeometry(QtCore.QRect(30, 290, 101, 31))
        ...
        self.save_btn.clicked.connect(self.image.clear)  # type: ignore
